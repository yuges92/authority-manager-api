                            ...
                            @foreach ($mainTopics as $mainTopic)
                              ...
                              <div class="tab-pane show" id="mainTopicTab{{$mainTopic->id}}" role="tabpanel">
                                <div class="nav-item row my-auto pl-2">
                                  <input type="checkbox" id="mainTopicCheckbox{{$mainTopic->id}}" class="filled-in chk-col-deep-purple main-topic-checkbox" name="maintopic_id[]" value="{{$mainTopic->id}}" data-checkbox="#checkAll{{$mainTopic->id}}">
                                  <label class="my-3 fs-2" for="mainTopicCheckbox{{$mainTopic->id}}">{{$mainTopic->name}}</label>
                                </div>

                                <div class="px-3">
                                  <input id="checkAll{{$mainTopic->id}}" type="checkbox" class="select-all-checkbox" data-target="topics{{$mainTopic->id}}"  name="maintopic_id[{{$mainTopic->id}}][selectAll]" data-parent="#mainTopicCheckbox{{$mainTopic->id}}">
                                ...
                                <div class="row mx-auto" id="topics{{$mainTopic->id}}">
                                  @foreach ($mainTopic->subtopics as $subtopic)
                                    ...
                                    <div class="col-md-6" >
                                      <input id="level2{{$subtopic->sectionid}}" type="checkbox"  class="subtopic-checkbox" data-parent="#mainTopicCheckbox{{$mainTopic->id}} name=""value="{{$subtopic->sectionid}}">
