        ...
        <div class="card-body wizard-content">
          ...
          <form action="#" class="tab-wizard wizard-circle wizard clearfix" role="application" id="steps-form">
            ...
            <div class="content clearfix">
              ...
              <section id="steps-uid-0-p-0" role="tabpanel" aria-labelledby="steps-uid-0-h-0" class="body current" aria-hidden="false" style="display:none">
                <div class="col-md-6">
